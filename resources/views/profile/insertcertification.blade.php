...
<div class="min-vh-100 d-flex justify-content-center" style="background-color: #F2F1EF">
    <div class="container my-5 px-5 py-3" style="background-color: white; border-radius: 20px;">
        ...
        <div class="container mt-4">
            <form role="form" action="/profile/certification/insert" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="form-group p-3 tcolor">
                    <label for="name">Certification Name</label>
                    <input class="form-control mt-1" type="text" name="name" id="name" placeholder="">
                </div>

                <div class="form-group p-3 tcolor">
                    <label for="provider">Certification Provider</label>
                    <input class="form-control mt-1" type="text" name="provider" id="provider" placeholder="">
                </div>
                ...
                <div class="form-group p-3 tcolor">
                    ...
                    <input class="form-control mt-1" type="text" name="link" id="link" placeholder="">
                </div>
