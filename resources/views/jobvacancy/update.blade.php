...
<div class="min-vh-100 d-flex justify-content-center" style="background-color: #F2F1EF">
    <div class="container my-5 px-5 py-3" style="background-color: white; border-radius: 20px;">
        ...
        <div class="container mt-4">
            <form role="form" action="/jobvacancy/update/{{$jobvacancy->jobVacancyID}}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group p-3">
                    ...
                    <select class="form-control" id="job" name="job">
                        ...
                        @if($jobvacancy->jobID == $job->jobID)  selected
                        @endif
                        >{{$job->jobName}}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group p-3 tcolor">
                    ...
                    <input class="form-control mt-1" type="text" name="duration" id="duration" placeholder="e.g. : 1 Months, 2 Week, etc." value="{{$jobvacancy->duration}}">
                </div>

                <div class="form-group p-3 tcolor">
                    <label for="description">Job Description</label>
                    <textarea class="form-control my-1" type="text" name="description" id="description" rows="2" placeholder="Description">{{$jobvacancy->description}}</textarea>
